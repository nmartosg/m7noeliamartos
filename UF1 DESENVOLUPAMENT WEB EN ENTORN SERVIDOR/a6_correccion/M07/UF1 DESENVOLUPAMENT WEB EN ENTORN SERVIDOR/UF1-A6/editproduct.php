...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($_FILES["imagen"])){
        mkdir("imatges/".getUserID($_SESSION["login"]), 0777);
        $dir_subida = 'imatges/'.getUserID($_SESSION["login"])."/";
    ...
    if(!ComprovarProducteUsuari($_SESSION["login"],$_REQUEST["idc"])){
        die("ERROR");
            ...
            $producte = getProductData($_REQUEST["idc"]);
            $nom = $producte["nom"];
            $desc = $producte["descripcio"];
...
<form method="post">
<center>
    <h2 style="color: #0000FF; ">EDITAR PRODUCTE</h2>
      <h3><strong>PRODUCTE:</strong></h3>
      <p>
...
<hr />
<center>
<h3>AFEGIR UNA CATEGORIA AL PRODUCTE:</h3>
</center>
...
<?php
 ...
 //CATEGORIES ACTUALS DEL PRODUCTE
